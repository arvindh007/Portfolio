				...
				<div class="col-span-4 flex-1 flex-col order-1 md:order-none">
					<div class="container mx-auto max-w-full 2xl:max-w-6xl">
						...
						<footer class="hidden text-center md:block mb-5">
							<p>🚀 Designed & Created by <a href="#" class="hover:text-link-color" target="_blank">ARVINDH.S.V</a></p>
							<a class="hover:text-link-color" target="_blank">Code available on Github 👾</a>
						</footer>
					</div>
				</div>
